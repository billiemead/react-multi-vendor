        ...
        <div className="min-w-screen min-h-screen bg-[#CDCAE9] flex justify-center items-center">
            <div className="w-[350px] text-[#ffffff] p-2" >
                <div className="bg-[#6f68d1] p-4 rounded-[2em]">
                    ...
                    <p className="text-md mb-3 font-light">Please Register your New Account</p>
                    <form onSubmit={submit}>
                        <div className="flex flex-col w-full gap-1 mb-3">
                            <label htmlFor="name" className="text-sm font-light">Name</label>
                            <input onChange={inputHandler} value={state.name} className="px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-[2em]" type="text" name="name" placeholder="Name" id="name" required />
                        </div>
                        <div className="flex flex-col w-full gap-1 mb-3">
                        ...
                        <button className="bg-slate-800 w-full hover:shadow-blue-300/50 hover:shadow-lg text-white rounded-[2em] px-7 py-2 mb-3 text-sm" >Register</button>
                        <div className="flex items-center mb-3 gap-3 justify-center">
                            <p className="text-sm" >Already have an Existing Account? <Link className="font-bold" to="/login">Login</Link></p>
                        </div>
