                    ...
                    <div className="bg-[#00aeef] p-4 rounded-[2em]">
                        ...
                        <form onSubmit={submit}>
                            <div className="flex flex-col w-full gap-1 mb-3">
                                ...
                                <input onChange={inputHandler} value={state.email} className="px-3 py-2 text-sm outline-none border border-white bg-white rounded-[2em]" type="email" name="email" placeholder="Email" id="email" required />
                            </div>
                            <div className="flex flex-col w-full gap-1 mb-3">
                                <label htmlFor="password" className="text-sm font-light">Password</label>
                                <input onChange={inputHandler} value={state.password} className="px-3 py-2 text-sm outline-none border border-white bg-white rounded-[2em]" type="password" name="password" placeholder="Password" id="password" required />
                            </div>
